    ...
    <section class="services-hero">
        ...
        <div class="services-container services-hero-inner">
            <div class="services-hero-content">
                ...
                <h1 class="services-hero-title">خدمات <?php echo esc_html($ct_site_name); ?></h1>
                ...
                <div class="services-hero-cta">
                    ...
                    <a href="<?php echo esc_url(computech_whatsapp_url(sprintf('السلام عليكم، أريد الاستفسار عن خدمات %s', $ct_site_name))); ?>" class="btn-whatsapp" target="_blank" rel="noopener">
            ...
            <div class="services-hero-image">
                ...
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/hero-computer-setup.png" alt="خدمات <?php echo esc_html($ct_site_name); ?>" class="services-hero-img">
            </div>
        </div>
    </section>
        ...
        <div class="services-container">
            <div class="services-featured-inner">
                <div class="services-featured-text">
                    ...
                    <p class="services-featured-desc">فريق <?php echo esc_html($ct_site_name); ?> يساعدك في تحديد أفضل جهاز حسب استخدامك، سواء للألعاب، العمل، الدراسة، التصميم، أو الاستخدام اليومي.</p>
                ...
                <div class="services-featured-image">
                    ...
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/offers-device-consultation.png" alt="استشارة قبل الشراء - <?php echo esc_html($ct_site_name); ?>" class="services-featured-img">
                </div>
            </div>
        </div>
    </section>
