...
<head>
    ...
    <link rel="icon" type="image/jpeg" href="<?php echo esc_url(get_template_directory_uri() . '/assets/images/icon.jpeg'); ?>">
    <?php wp_head(); ?>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
<?php
$computech_logo_label = computech_header_label('logo_aria_label', get_bloginfo('name'));
...
$computech_account_label = computech_header_label('account_label', '');
...
$computech_whatsapp_number = computech_clean_phone(computech_header_setting('whatsapp_number', ''));
    ...
    <header class="main-header">
        <div class="header-container">
            ...
            <?php if ($computech_whatsapp_url !== '') : ?>
                <a href="<?php echo esc_url($computech_whatsapp_url); ?>" class="whatsapp-btn" target="_blank" rel="noopener">
        ...
        <div class="mobile-menu">
            ...
            <div class="mobile-menu-content">
                ...
                <ul class="mobile-nav-list">
                    ...
                    <?php if ($computech_whatsapp_url !== '') : ?>
                        <li class="mobile-whatsapp-item">
                            <a href="<?php echo esc_url($computech_whatsapp_url); ?>" class="mobile-nav-link mobile-whatsapp-menu-link" target="_blank" rel="noopener">
                                <span class="mobile-whatsapp-icon" aria-hidden="true">
